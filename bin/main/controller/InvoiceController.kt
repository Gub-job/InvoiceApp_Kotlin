...
class InvoiceController {
    ...
    private fun simpanInvoiceDanDetail() {
        ...
        try {
            ...
            stmt.setDouble(6, ppnField.text.toDoubleOrNull() ?: 0.0)
            stmt.executeUpdate()
            ...
            conn.rollback()
            showAlert("Error", "Gagal menyimpan invoice: ${e.message}. Pastikan tabel 'invoice' dan 'detail_invoice' sudah ada.")
        } finally {
            conn.close()
        }
    }
